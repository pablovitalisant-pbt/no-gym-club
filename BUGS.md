...
## Bug #6: PWA no se abre en pantalla completa (barra de direcciones visible)
- **Fecha**: 2026-07-24
- **Clasificación**: F = Feature ausente (no era una regresión de código — nunca existió configuración de PWA)
